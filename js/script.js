...
const translations = {
    en: {
        client: {
            nav: { home: "Developer Portfolio", services: "Services", work: "Work", contact: "Contact" },
            hero: {
                title: "Digital Solutions That Grow Your Business",
                subtitle: "I build premium websites and applications that convert visitors into customers.",
                cta: "Start Your Project"
            },
            services: {
                title: "How I Can Help You",
                web: { title: "Custom Websites", desc: "Tailor-made websites that reflect your brand and work perfectly on all devices." },
                app: { title: "Web Applications", desc: "Complex functionality made simple. Dashboards, booking systems, and more." },
                seo: { title: "SEO & Performance", desc: "Fast loading times and optimizations to help you rank higher on Google." }
            },
            process: {
                title: "My Process",
                step1: { title: "1. Strategy", desc: "We discuss your goals and target audience." },
                step2: { title: "2. Design & Code", desc: "I build your solution using modern technology." },
                step3: { title: "3. Launch", desc: "We go live and I ensure everything runs smoothly." }
            },
            cta_section: {
        ...
        hero: {
            ...
            description: "Building modern, scalable web apps with clean UI and reliable APIs. Based in Germany, open to full-time roles and selected client projects.",
        ...
        services: {
            ...
            s1: { title: "Full-Stack Web Development", desc: "End-to-end development using Next.js, Node.js, and Laravel for scalable, robust applications." },
            s2: { title: "Business Websites", desc: "High-conversion landing pages and corporate sites designed to build trust and drive growth." },
            s3: { title: "Performance & UX", desc: "Optimizing speed, refining user flows, and conducting UI cleanup for a superior user experience." }
        },
        projects: {
            title: "Featured Projects",
            view: "Live Website",
            p1: { type: "Service Website", desc: "A professional service website designed to build trust, present services clearly, and convert visitors into inquiries." },
            p2: { type: "Product & Brand", desc: "A product-focused website with a strong brand identity and responsive layout, built to scale with e-commerce features." },
            p3: { type: "Concept Website", desc: "A premium company website concept with modern sections, clear content hierarchy, and a professional visual system." },
            p4: { type: "Knowledge Platform", desc: "A structured multilingual content platform designed for scalability, readability, and modern UI — including dark-mode-first design." }
        },
        experience: {
            title: "Experience",
            ongoing: "Ongoing",
        ...
        footer: { back: "Back to Top", copyright: "© 2025 Ayman Plöger. All rights reserved." }
    },
    de: {
        client: {
            nav: { home: "Entwickler Portfolio", services: "Leistungen", work: "Arbeiten", contact: "Kontakt" },
            hero: {
                title: "Digitale Lösungen für Ihr Wachstum",
                subtitle: "Ich entwickle Premium-Webseiten und Apps, die Besucher in Kunden verwandeln.",
                cta: "Projekt Starten"
            },
            services: {
                title: "Wie ich Ihnen helfe",
                web: { title: "Individuelle Webseiten", desc: "Maßgeschneiderte Webseiten, die Ihre Marke widerspiegeln und auf allen Geräten perfekt funktionieren." },
                app: { title: "Web Applikationen", desc: "Komplexe Funktionen einfach gemacht. Dashboards, Buchungssysteme und mehr." },
                seo: { title: "SEO & Performance", desc: "Schnelle Ladezeiten und Optimierungen für ein besseres Google-Ranking." }
            },
            process: {
                title: "Mein Prozess",
                step1: { title: "1. Strategie", desc: "Wir besprechen Ihre Ziele und Ihre Zielgruppe." },
                step2: { title: "2. Design & Code", desc: "Ich baue Ihre Lösung mit modernster Technologie." },
                step3: { title: "3. Launch", desc: "Wir gehen live und ich sorge für einen reibungslosen Start." }
            },
            cta_section: {
        ...
        hero: {
            ...
            description: "Ich entwickle moderne, skalierbare Web-Apps mit sauberer UI und zuverlässigen APIs. Ansässig in Deutschland, offen für Vollzeitstellen und ausgewählte Kundenprojekte.",
        ...
        services: {
            ...
            s1: { title: "Full-Stack Entwicklung", desc: "End-to-End Entwicklung mit Next.js, Node.js und Laravel für skalierbare Anwendungen." },
            s2: { title: "Business Webseiten", desc: "Konversionsstarke Landing Pages und Unternehmensseiten, die Vertrauen aufbauen." },
            s3: { title: "Performance & UX", desc: "Optimierung von Ladezeiten, Nutzerführung und UI-Bereinigung für eine bessere User Experience." }
        },
        projects: {
            title: "Ausgewählte Projekte",
            view: "Zur Webseite",
            p1: { type: "Service Webseite", desc: "Eine professionelle Service-Webseite, entwickelt um Vertrauen aufzubauen und Besucher in Anfragen zu konvertieren." },
            p2: { type: "Produkt & Marke", desc: "Eine produktfokussierte Webseite mit starker Markenidentität und responsivem Layout, skalierbar für E-Commerce." },
            p3: { type: "Konzept Webseite", desc: "Ein Premium-Firmenkonzept mit modernen Sektionen, klarer Hierarchie und professionellem Designsystem." },
            p4: { type: "Wissensplattform", desc: "Eine strukturierte, mehrsprachige Content-Plattform, designed für Skalierbarkeit und Lesbarkeit (Dark Mode First)." }
        },
        experience: {
            title: "Erfahrung",
            ongoing: "Laufend",
        ...
        footer: { back: "Nach Oben", copyright: "© 2025 Ayman Plöger. Alle Rechte vorbehalten." }
    },
    ar: {
        client: {
            nav: { home: "ملف المطور", services: "خدماتي", work: "أعمالي", contact: "تواصل معي" },
            hero: {
                title: "حلول رقمية لتنمية عملك",
                subtitle: "أقوم بإنشاء مواقع وتطبيقات متميزة تحول الزوار إلى عملاء دائمين.",
                cta: "ابدأ مشروعك"
            },
            services: {
                title: "كيف يمكنني مساعدتك",
                web: { title: "مواقع مخصصة", desc: "مواقع مصممة خصيصاً لتعكس علامتك التجارية وتعمل بامتياز على جميع الأجهزة." },
                app: { title: "تطبيقات الويب", desc: "وظائف معقدة بأسلوب بسيط. لوحات تحكم، أنظمة حجز، والمزيد." },
                seo: { title: "تحسين الأداء والبحث", desc: "سرعة تحميل عالية وتحسينات لتصدر نتائج البحث في جوجل." }
            },
            process: {
                title: "كيف أعمل",
                step1: { title: "1. الاستراتيجية", desc: "نناقش أهدافك وجمهورك المستهدف." },
                step2: { title: "2. التصميم والتطوير", desc: "أبني حلولك باستخدام أحدث التقنيات." },
                step3: { title: "3. الإطلاق", desc: "نطلق المشروع وأضمن أن يعمل كل شيء بسلاسة." }
            },
            cta_section: {
        ...
        hero: {
            ...
            description: "أقوم ببناء تطبيقات ويب حديثة وقابلة للتوسع بتصاميم نظيفة وواجهات برمجة موثوقة. مقيم في ألمانيا ومتاح للعمل بدوام كامل أو لمشاريع مختارة.",
        ...
        services: {
            ...
            s1: { title: "تطوير ويب شامل", desc: "تطوير متكامل باستخدام Next.js و Node.js و Laravel لتطبيقات قوية وقابلة للتوسع." },
            s2: { title: "مواقع الأعمال", desc: "صفحات هبوط ومواقع شركات مصممة لزيادة التحويل وبناء الثقة." },
            s3: { title: "الأداء وتجربة المستخدم", desc: "تحسين السرعة، وتنقيح تدفق المستخدم، وتنظيف الواجهة لتجربة مستخدم فائقة." }
        },
        projects: {
            title: "مشاريع مميزة",
            view: "زيارة الموقع",
            p1: { type: "موقع خدمي", desc: "موقع خدمات احترافي مصمم لبناء الثقة وعرض الخدمات بوضوح وتحويل الزوار إلى عملاء." },
            p2: { type: "منتج وعلامة تجارية", desc: "موقع يركز على المنتج مع هوية تجارية قوية وتخطيط متجاوب، مبني للتوسع مع ميزات التجارة الإلكترونية." },
            p3: { type: "مفهوم موقع شركة", desc: "مفهوم موقع شركة متميز بأقسام حديثة، وتسلسل هرمي واضح للمحتوى، ونظام بصري احترافي." },
            p4: { type: "منصة معرفية", desc: "منصة محتوى منظمة متعددة اللغات مصممة للقابلية للتوسع والقراءة، وتصميم يدعم الوضع المظلم أولاً." }
        },
        experience: {
            ...
            r1: {
                ...
                desc: "<li>بناء مواقع متجاوبة مع واجهة مستخدم متميزة وهيكلة واضحة.</li><li>تحسين تجربة المستخدم لسحب وجذب العملاء بشكل أفضل.</li><li>تسليم التحديثات والتحسينات بناءً على ملاحظات حقيقية.</li>"
            },
            r2: {
        ...
        footer: { back: "العودة للأعلى", copyright: "© 2025 Ayman Plöger. جميع الحقوق محفوظة." }
    }
};
...
function setLanguage(lang) {
    ...
    elements.forEach(el => {
        ...
        if (value) {
            ...
            if (el.tagName === 'UL' || key.includes('p1') || key.includes('p2') || key.includes('objective')) {
                el.innerHTML = value;
            } else {
